...
set "NOTEBOOK=experiment_2026_09_06_baseline_bounded_single_shot.ipynb"
set "LOG_DIR=logs_baseline_b_ss"
...
call :STATUS "Starting bounded-alpha single-shot timing baseline: 8 shards, %TORCH_THREADS% Torch threads/shard"
...
call :STATUS "bounded-alpha single-shot timing baseline complete"
exit /B 0
