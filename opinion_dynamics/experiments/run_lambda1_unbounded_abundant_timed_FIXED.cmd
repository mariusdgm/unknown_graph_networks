...
set NOTEBOOK=experiment_2026_09_14_lambda1_unbounded_abundant_FIXED.ipynb
set LOG_DIR=logs_lambda1_ab
...
echo Launching lambda=1 unbounded abundant: 8 shards, %TORCH_THREADS% Torch threads/shard.
...
echo All shards finished. Running the global validation/merge once in non-worker mode...
...
echo Lambda=1 unbounded abundant complete.
exit /b 0
